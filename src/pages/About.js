...
const skillsDataDMA = [
  ...
  return (
    <section className="about-section">
      <h2>About Me</h2>
      <p>
         A motivated Computer Engineering graduate (Andalas University, 2025) with a strong foundation in
 Data Science from the Bangkit Program. Experienced in applying analytical and problem-solving skills
 using Python and SQL for data processing, visualization, and model development. Through multiple
 online courses, I have developed a solid understanding of software testing fundamentals, including test
 case management, automation testing, and manual testing, and have gained hands-on project
 experience using Selenium. Highly motivated to pursue opportunities in Quality Assurance and
 Software Testing, with a strong interest in ensuring product reliability, performance, and user
 satisfaction within the software development lifecycle
      </p>
